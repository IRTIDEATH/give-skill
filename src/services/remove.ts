...
import { getAllSkills, removeSkillInstallation } from '../core/state/global.js';
import { getAllLocalSkills, findLocalSkillInstallations, removeLocalSkill } from '../core/state/local.js';
